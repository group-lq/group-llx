...
<body>
	...
	<br>
			<h2 id="h2"><span class="logined" onclick="replaced()" id="d1">手机找回</span>|<span id="d2" class="logined" onclick="replaced1()">邮箱找回</span>
				...
				<div class="web-width" id="form1" ><!-- 填写账户名 -->
		     ...
		     <input type="hidden" name="op" value="Clogin" id="hid">
		       ...
		       <div class="subtijiao"><input type="button" value="提交" onclick="skip()" /></div> 
		      </form>
		   </div>
				<div class="web-width" id="form2" style="display:none;"><!-- 验证身份 -->
				 <div class="for-liucheng">
			      <div class="liulist for-cur"></div>
			      <div class="liulist for-cur"></div>
			      <div class="liulist"></div>
			     ...
			     <form action="" method="post" class="forget-pwd">
			       <dl class="sel-yzsj" class="tel">
			        <dt>已验证手机：</dt>
			        <dd ><input type="text" value="" required="" /></dd>
			        <div class="clears"></div>
			       </dl>
			       <dl class="sel-yzyx" class="email" style="display:none;">
			        <dt>已验证邮箱：</dt>
			        <dd ><input type="text" value=""  required=""/></dd>
			        <div class="clears"></div>
			       </dl>
			       <dl class="tel">
			        ...
			        <dl class="email" style="display:none;">
			        <dt>手机校验码：</dt>
			        <dd><input type="text" required=""/> <button>获取邮箱验证码</button></dd>
			        <div class="clears"></div>
			       </dl>
			       <div class="subtijiao"><input type="button" value="提交" onclick="skip1()" /></div> 
			      </form>
			   
			</div>
			<div class="web-width" id="form3" style="display:none;"><!-- 设置新密码 -->
			 <div class="for-liucheng">
      <div class="liulist for-cur"></div>
      <div class="liulist for-cur"></div>
      <div class="liulist for-cur"></div>
 ...
 <form action="" method="get" class="forget-pwd">
			       ...
			       <div class="subtijiao"><input type="button" value="提交" onclick="skip2()" /></div> 
			      </form><!--forget-pwd/-->
   			</div><!--web-width/-->
			
			<div class="successs" id="form4" style="display:none;">
			 <div class="for-liucheng">
		      <div class="liulist for-cur"></div>
		      <div class="liulist for-cur"></div>
		      <div class="liulist for-cur"></div>
