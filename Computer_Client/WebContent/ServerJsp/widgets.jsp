				...
				<div class="elements  row">
					<div class="col-md-4 profile widget-shadow">
						...
						<div class="profile-top">
							<img src="${base}/images/Server/img1.png" alt="">
							<h4>Wikolia smith</h4>
					...
					<div class="col-md-4 profile widget-shadow chat-mdl-grid">
						...
						<div class="scrollbar scrollbar1">
							<div class="activity-row activity-row1 activity-right">
								<div class="col-xs-3 activity-img"><img src="${base}/images/Server/1.png" class="img-responsive" alt=""></div>
							...
							<div class="activity-row activity-row1 activity-left">
								...
								<div class="col-xs-3 activity-img"><img src="${base}/images/Server/3.png" class="img-responsive" alt=""></div>
								<div class="clearfix"> </div>
							</div>
							<div class="activity-row activity-row1 activity-right">
								<div class="col-xs-3 activity-img"><img src="${base}/images/Server/1.png" class="img-responsive" alt=""></div>
							...
							<div class="activity-row activity-row1 activity-left">
								...
								<div class="col-xs-3 activity-img"><img src="${base}/images/Server/2.png" class="img-responsive" alt=""></div>
								<div class="clearfix"> </div>
							</div>
							<div class="activity-row activity-row1 activity-right">
								<div class="col-xs-3 activity-img"><img src="${base}/images/Server/1.png" class="img-responsive" alt=""></div>
