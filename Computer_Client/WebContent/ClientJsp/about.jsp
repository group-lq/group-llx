                ...
                <div class="bd over">
                    <div class="bar relative fz0 nowrap">
                        <div class="item relative inline-block text-center fz0 over item-0">
                            <img src="${pageContext.servletContext.contextPath}/picture/about.png" alt="" class="max-w100">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div id="about" class="wrap">
                <div class="clean">
                    <div class="item fr fz0 text-center wow fadeInUp">
                        <img src="${pageContext.servletContext.contextPath}/picture/db39253b5d.jpg" alt="" class="max-w100">
                    </div>
                ...
                <div class="clean relative">
                    <div class="item fl fz0 text-center wow fadeInUp">
                        <img src="${pageContext.servletContext.contextPath}/picture/18beffa957.jpg" alt="" class="max-w100">
                    </div>
                    ...
                    <div class="item item0 fl relative text-center wow fadeInUp">
                        <div class="img grayscale">
                            <a href="#"​ class="trans block" title="团队18" rel="nofollow">
                                <img src="${pageContext.servletContext.contextPath}/picture/1-1f9291239550-l.jpg" alt="团队18" class="grayscale-img max-w100 trans">
                            </a>
                        </div>
                    </div>
                    <div class="item item0 fl relative text-center wow fadeInUp">
                        <div class="img grayscale">
                            <a href="#"​ class="trans block" title="团队17" rel="nofollow">
                                <img src="${pageContext.servletContext.contextPath}/picture/1-1f9291239440-l.jpg" alt="团队17" class="grayscale-img max-w100 trans">
                            </a>
                        </div>
                    </div>
                    <div class="item item0 fl relative text-center wow fadeInUp">
                        <div class="img grayscale">
                            <a href="#"​ class="trans block" title="团队16" rel="nofollow">
                                <img src="${pageContext.servletContext.contextPath}/picture/1-1f9291239330-l.jpg" alt="团队16" class="grayscale-img max-w100 trans">
                            </a>
                        </div>
                    </div>
                    <div class="item item0 fl relative text-center wow fadeInUp">
                        <div class="img grayscale">
                            <a href="#"​ class="trans block" title="团队15" rel="nofollow">
                                <img src="${pageContext.servletContext.contextPath}/picture/1-1f9291239220-l.jpg" alt="团队15" class="grayscale-img max-w100 trans">
                            </a>
                        </div>
                    </div>
                    <div class="item item0 fl relative text-center wow fadeInUp">
                        <div class="img grayscale">
                            <a href="#"​ class="trans block" title="团队14" rel="nofollow">
                                <img src="${pageContext.servletContext.contextPath}/picture/1-1f9291239100-l.jpg" alt="团队14" class="grayscale-img max-w100 trans">
                            </a>
                        </div>
                    </div>
                    <div class="item item0 fl relative text-center wow fadeInUp">
                        <div class="img grayscale">
                            <a href="#"​ class="trans block" title="团队13" rel="nofollow">
                                <img src="${pageContext.servletContext.contextPath}/picture/1-1f929123u90-l.jpg" alt="团队13" class="grayscale-img max-w100 trans">
                            </a>
                        </div>
                    </div>
                    <div class="item item0 fl relative text-center wow fadeInUp">
                        <div class="img grayscale">
                            <a href="#"​ class="trans block" title="团队12" rel="nofollow">
                                <img src="${pageContext.servletContext.contextPath}/picture/1-1f929123t70-l.jpg" alt="团队12" class="grayscale-img max-w100 trans">
                            </a>
                        </div>
                    </div>
                    <div class="item item0 fl relative text-center wow fadeInUp">
                        <div class="img grayscale">
                            <a href="#"​ class="trans block" title="团队11" rel="nofollow">
                                <img src="${pageContext.servletContext.contextPath}/picture/1-1f929123s40-l.jpg" alt="团队11" class="grayscale-img max-w100 trans">
                            </a>
                        </div>
                    </div>
                    <div class="item item0 fl relative text-center wow fadeInUp">
                        <div class="img grayscale">
                            <a href="#"​ class="trans block" title="团队10" rel="nofollow">
                                <img src="${pageContext.servletContext.contextPath}/picture/1-1f929123j10-l.jpg" alt="团队10" class="grayscale-img max-w100 trans">
                            </a>
                        </div>
                    </div>
                    <div class="item item0 fl relative text-center wow fadeInUp">
                        <div class="img grayscale">
                            <a href="#"​ class="trans block" title="团队9" rel="nofollow">
                                <img src="${pageContext.servletContext.contextPath}/picture/1-1f9291235140-l.jpg" alt="团队9" class="grayscale-img max-w100 trans">
                            </a>
                        </div>
                    </div>
                    <div class="item item0 fl relative text-center wow fadeInUp">
                        <div class="img grayscale">
                            <a href="#"​ class="trans block" title="团队8" rel="nofollow">
                                <img src="${pageContext.servletContext.contextPath}/picture/1-1f9291235000-l.jpg" alt="团队8" class="grayscale-img max-w100 trans">
                            </a>
                        </div>
                    </div>
                    <div class="item item0 fl relative text-center wow fadeInUp">
                        <div class="img grayscale">
                            <a href="#"​ class="trans block" title="团队7" rel="nofollow">
                                <img src="${pageContext.servletContext.contextPath}/picture/1-1f9291234480-l.jpg" alt="团队7" class="grayscale-img max-w100 trans">
                            </a>
                        </div>
                    </div>
                    <div class="item item0 fl relative text-center wow fadeInUp">
                        <div class="img grayscale">
                            <a href="#"​ class="trans block" title="团队6" rel="nofollow">
                                <img src="${pageContext.servletContext.contextPath}/picture/1-1f9291233220-l.jpg" alt="团队6" class="grayscale-img max-w100 trans">
                            </a>
                        </div>
                    </div>
                    <div class="item item0 fl relative text-center wow fadeInUp">
                        <div class="img grayscale">
                            <a href="#"​ class="trans block" title="团队5" rel="nofollow">
                                <img src="${pageContext.servletContext.contextPath}/picture/1-1f9291233060-l.jpg" alt="团队5" class="grayscale-img max-w100 trans">
                            </a>
                        </div>
                    </div>
                    <div class="item item0 fl relative text-center wow fadeInUp">
                        <div class="img grayscale">
                            <a href="#"​ class="trans block" title="团队4" rel="nofollow">
                                <img src="${pageContext.servletContext.contextPath}/picture/1-1f9291232480-l.jpg" alt="团队4" class="grayscale-img max-w100 trans">
                            </a>
                        </div>
                    </div>
                    <div class="item item0 fl relative text-center wow fadeInUp">
                        <div class="img grayscale">
                            <a href="#"​ class="trans block" title="团队3" rel="nofollow">
                                <img src="${pageContext.servletContext.contextPath}/picture/1-1f9291232350-l.jpg" alt="团队3" class="grayscale-img max-w100 trans">
                            </a>
                        </div>
                    </div>
                    <div class="item item0 fl relative text-center wow fadeInUp">
                        <div class="img grayscale">
                            <a href="#"​ class="trans block" title="团队2" rel="nofollow">
                                <img src="${pageContext.servletContext.contextPath}/picture/1-1f9291232180-l.jpg" alt="团队2" class="grayscale-img max-w100 trans">
                            </a>
                        </div>
                    </div>
                    <div class="item item0 fl relative text-center wow fadeInUp">
                        <div class="img grayscale">
                            <a href="#"​ class="trans block" title="团队1" rel="nofollow">
                                <img src="${pageContext.servletContext.contextPath}/picture/1-1f9291141050-l.jpg" alt="团队1" class="grayscale-img max-w100 trans">
                            </a>
                        </div>
                    </div>
                </div>
