       ...
       <div class="liutext"><em>4</em><br /><strong>完成</strong></div>
 		...
 		<form action="${base}/user.s" method="post" class="forget-pwd">
 			<input type="hidden" name="op" value="modify">
			       <!-- <dl>
			        <dt style="font-weight: bold;font-size: 15px;color: silver;">手机号：</dt>
			        <dd><input type="text" required=""/></dd>
			        <div class="clears"></div>
			       </dl> --> 
			       <dl>
			        <dt style="font-weight: bold;font-size: 15px;color: silver;">新密码：</dt>
			        <dd><input type="password" name="pwd" required/><c:if test="${! empty checkNameMsg}"><span style="font-weight: bold;font-size: 15px;color: red;">${modify}</span></c:if></dd>
			        <div class="clears"></div>
			       </dl> 
			       <dl>
			        <dt style="font-weight: bold;font-size: 15px;color: silver;">确认密码：</dt>
			        <dd><input type="password" name="retpwd" required/><c:if test="${! empty checkNameMsg}"><span style="font-weight: bold;font-size: 15px;color: red;">${modify}</span></c:if></dd>
			        <div class="clears"></div>
			       </dl> 
